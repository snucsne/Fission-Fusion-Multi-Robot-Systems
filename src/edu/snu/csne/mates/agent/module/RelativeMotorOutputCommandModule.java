 ...
 */
public class RelativeMotorOutputCommandModule extends AbstractAgentModule
{
    /** Our logger */
    private static final Logger _LOG = LogManager.getLogger(
            RelativeMotorOutputCommandModule.class.getName() );
    
    
    /** The control object associated with the agent */
    private RigidBodyControl _control = null;
    
    
    /** Relative steering speed output variable */
    private FloatVariable _steerSpeedRelativeVar = null;

    /** Steering yaw output variable */
    private FloatVariable _steerYawVar = null;

    /** Steering pitch output variable */
    private FloatVariable _steerPitchVar = null;

    /** Steering roll output variable */
    private FloatVariable _steerRollVar = null;

    /** Flag indicating whether or not pitch control is enabled */
    ...
    public void initialize( Agent agent, SimulationState simState )
    {
        ...
        // Get the control object for the agent
        // TODO
